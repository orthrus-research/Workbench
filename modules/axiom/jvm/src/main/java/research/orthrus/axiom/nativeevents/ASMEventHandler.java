...
public class ASMEventHandler implements IEventListener
{
    ...
    private final EventContext.Owner owner;
    private final String readable;

    @Deprecated
    public ASMEventHandler(Object target, Method method, EventContext.Owner owner) throws Exception
    {
        this(target, method, owner, false);
    }

    public ASMEventHandler(Object target, Method method, EventContext.Owner owner, boolean isGeneric) throws Exception
    {
        this.owner = owner;
