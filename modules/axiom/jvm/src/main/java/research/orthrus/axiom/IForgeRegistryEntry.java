...
interface IForgeRegistryEntry<V>
{
     ...
     */
    V setRegistryName(NativeLocation name);
    ...
    NativeLocation getRegistryName();
    ...
    class Impl<T  extends IForgeRegistryEntry<T>> implements IForgeRegistryEntry<T>
    {
        ...
        private NativeLocation registryName = null;
        ...
        public final T setRegistryName(String name)
        {
            ...
            this.registryName = ForgeEntryNames.checkPrefix(name, true);
            return (T)this;
        }

        //Helper functions
        @Override
        public final T setRegistryName(NativeLocation name){ return setRegistryName(name.toString()); }
        public final T setRegistryName(String modID, String name){ return setRegistryName(modID + ":" + name); }
        @Override

        public final NativeLocation getRegistryName()
        {
