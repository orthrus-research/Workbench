...
class BlastProperty implements IMaterialProperty {
    ...
    /**
     * Blast Furnace Temperature of this FluidMaterial. If below 1000K, Primitive Blast Furnace recipes will be also added.
     * If above 1750K, a Hot Ingot and its Vacuum Freezer recipe will be also added.
     * <p>
     * If a FluidMaterial with this Property has a NativeFluid, its temperature will be set to this if it is the default NativeFluid
     * temperature.
     */
    private int blastTemperature;

    /**
     * The {@link GasTier} of this FluidMaterial, representing which Gas EBF recipes will be generated.
     * <p>
    ...
    public void setGasTier( GasTier tier) {
        this.gasTier = tier;
    }
    ...
    public static GasTier validateGasTier(String name) {
