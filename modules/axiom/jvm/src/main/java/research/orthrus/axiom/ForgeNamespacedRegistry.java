...
class ForgeNamespacedRegistry<V extends IForgeRegistryEntry<V>> extends NativeNamedRegistry<NativeLocation, V> implements ILockableRegistry
{
    ...
    public static class Factory<V extends IForgeRegistryEntry<V>> implements IForgeRegistry.CreateCallback<V>
    {
        ...
        {
            owner.setSlaveMap(ID, new ForgeNamespacedRegistry<V>((ForgeRegistry<V>)owner));
        }
    }
}
