...
class MaterialFlags {
    ...
    public void verify(FluidMaterial material) {
    ...
    /**
     * Add this to your FluidMaterial if you want to have its Ore Calcite heated in a Blast Furnace for more output. Already
     * listed are:
    ...
    public static final MaterialFlag SOLDER_MATERIAL = new MaterialFlag.Builder("solder_material")
            .requireProps(FluidDomain.FLUID)
            .build();
    ...
    /**
     * Add this to your FluidMaterial if it is a magnetized form of another FluidMaterial.
     */
