...
/** Fresh native class space for the explicitly composed generated families. */
public final class NativeMaterialBlockConformance {
    public static void main(String[] args) throws Exception {
        ...
        try (var context = NativeVanillaIdentities.openProgram(Path.of(args[0]), Path.of(args[1]), programs)) {
            context.initialize();
            Object result = context.runMaterialProgram("NativeMaterialBlockProbe", args[6]);
