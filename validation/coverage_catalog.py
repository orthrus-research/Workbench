...
OWNER_COVERAGE: dict[str, tuple[CoverageArea, ...]] = {
    ...
    "blueprints": (
        ...
        _area("runtime-custody", "Lifecycle, simulation and filesystem publication preserve rollback, drift and no-side-effect gates.", "test_lifecycle.py", "test_simulation.py", "test_publication_filesystem.py"),
    ),
    "crucible": (
